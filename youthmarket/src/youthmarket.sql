...
VALUES (1, '김철수', '제목 1', '이것은 첫 번째 질문의 내용입니다.', 'image1.jpg', 10, TO_DATE('2024-09-01', 'YYYY-MM-DD'));
INSERT INTO QA (QA_NO, QA_NAME, QA_TITLE, QA_CONTENT, QA_IMG, QA_HIT, CREATE_DATE)
VALUES (2, '이영희', '제목 2', '이것은 두 번째 질문의 내용입니다.', 'image2.jpg', 5, TO_DATE('2024-09-02', 'YYYY-MM-DD'));
INSERT INTO QA (QA_NO, QA_NAME, QA_TITLE, QA_CONTENT, QA_IMG, QA_HIT, CREATE_DATE)
VALUES (3, '박영수', '제목 3', '이것은 세 번째 질문의 내용입니다.', 'image3.jpg', 15, TO_DATE('2024-09-03', 'YYYY-MM-DD'));
INSERT INTO QA (QA_NO, QA_NAME, QA_TITLE, QA_CONTENT, QA_IMG, QA_HIT, CREATE_DATE)
VALUES (4, '최민준', '제목 4', '이것은 네 번째 질문의 내용입니다.', 'image4.jpg', 8, TO_DATE('2024-09-04', 'YYYY-MM-DD'));
INSERT INTO QA (QA_NO, QA_NAME, QA_TITLE, QA_CONTENT, QA_IMG, QA_HIT, CREATE_DATE)
VALUES (5, '정수민', '제목 5', '이것은 다섯 번째 질문의 내용입니다.', 'image5.jpg', 20, TO_DATE('2024-09-05', 'YYYY-MM-DD'));
...
update notice set NOTICE_TYPE='이벤트1' where notice_no between 19 and 28;
update notice set NOTICE_IMG='공지사항.png' where notice_no between 10 and 18;
ALTER TABLE NOTICE MODIFY (notice_Content CLOB);
