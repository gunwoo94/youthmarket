...
<title>youthmarket reportSearchAfter</title>
<style>
	.main-section{
	 width: 70%;
	 height: auto;
	...
	<div class="main-section">
		<div class="main-box">
        	...
        	<div class="report-line"></div>
              ...
              <button class="report-search-button" onclick="location.href='${pageContext.request.contextPath}/report/reportSearch'" style="margin-top: 247px;margin-right: -53px;">다시 조회하기</button>
