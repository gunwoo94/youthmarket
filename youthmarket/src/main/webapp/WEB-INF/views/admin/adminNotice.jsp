...
<body>
			...
			<div id="layout-body">
				<div class="main-container">
					<div class="content">
						...
						<div class="top-div">
							<div class="top-title">공지사항 관리
							<a class="btn btn-primary btn-lg "  href="adminNoticeWriteForm.do" role="button" >글쓰기</a>
							</div>
						</div>
					</div>
				</div>
	...
	<c:if test="${pb.startPage > pb.pagePerBlock }">
		<li class="page-item"><a class="page-link" href="${path }/admin/adminUser.do?pageNum=1">
			<i class="icofont-duotone icofont-arrow-first"></i></a></li>
		<li class="page-item"><a class="page-link" href="${path }/admin/adminUser.do?pageNum=${pb.startPage -1 }">
			<i class="bi bi-arrow-left-circle"></i></a></li>
	</c:if>
	<c:forEach var="i" begin="${pb.startPage }" end="${pb.endPage }">
		<c:if test="${pb.currentPage == i }">
			<li class="page-item"><a class="page-link active" href="${path }/admin/adminUser.do?pageNum=${i}">${i }</a></li>
		</c:if>
		<c:if test="${pb.currentPage != i }">
			<li class="page-item"><a class="page-link" href="${path }/admin/adminUser.do?pageNum=${i}">${i }</a></li>
		</c:if>
	</c:forEach>
	<!-- 뒤에 보여줄 것이 있다 -->
	<c:if test="${pb.endPage < pb.totalPage }">
		<li class="page-item"><a class="page-link" href="${path }/admin/adminUser.do?pageNum=${pb.endPage+1 }">
			<i class="bi bi-arrow-right-circle"></i></a></li>
		<li class="page-item"><a class="page-link" href="${path }/admin/adminUser.do?pageNum=${pb.totalPage}">
