...
<body>
	<div class="m-container">
		<div class="menu-main-container">
			<div class="menu-div" onclick="pageView('adminLoginForm.do', '로그인 후에 사용 가능 합니다.')">
				<img class="menu-img5"  >&nbsp;관리자 페이지
			</div>
			<div class="menu-div" onclick="pageView('adminUser.do','로그인 후에 사용 가능 합니다.')">
				<img class="menu-img" alt="이미지 없음"
					src="/youthmarket/resources/images/admin/유저.png" />&nbsp;유저 관리
			</div>
			<div class="menu-div" onclick="pageView('adminBoard.do','로그인 후에 사용 가능 합니다.')">
				<img class="menu-img2" alt="이미지 없음"
					src="/youthmarket/resources/images/admin/게시글.png" />&nbsp;게시글 관리
			</div>
			<div class="menu-div" onclick="pageView('adminNotice.do', '로그인 후에 사용 가능 합니다.')">
				<img class="menu-img" alt="이미지 없음"
					src="/youthmarket/resources/images/admin/공지사항.png" />&nbsp; 공지사항 관리
				
			</div>
			<div class="menu-div" onclick="pageView('adminBlockList.do', '로그인 후에 사용 가능 합니다.')">
				<img class="menu-img" alt="이미지 없음"
		...
		<div class="loginForm" align="center">
			...
			<form action="adminLogin.do" method="post">
				<div class="login-wrap">
					...
					<div><input class="login-input login-input2" type="text" name="adminId" required="required" placeholder="아이디" ></div>
					<div><input class="login-input login-input2" type="password" name="adminPassword" required="required" placeholder="비밀번호"></div>
