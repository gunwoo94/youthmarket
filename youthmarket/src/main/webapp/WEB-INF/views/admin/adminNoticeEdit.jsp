...
<body>
	<div class="m-container">
		<div class="menu-main-container">
			...
			<div class="menu-div"
				onclick="pageView('/youthmarket/sell/home.do', '홈페이지로 이동합니다.')">
				<img class="menu-img" alt="이미지 없음"
					src="/youthmarket/resources/images/admin/차단.png" />&nbsp; 홈페이지로 이동
			</div>
		</div>
		<div class="adminboard-container">
			...
			<div id="layout-body">
				<div class="container-sm">
					<div class="top-title">공지사항 수정</div>
					<%-- 수정 폼 --%>
					<form action="${path }/admin/adminNoticeAction.do" method="post">
						<!-- 공지사항 ID를 숨겨진 필드에 저장 -->
						<input type="hidden" name="noticeNo" value="${notice.noticeNo}">

						<!-- 제목 필드에 기존 제목을 채워넣음 -->
						<input type="text" name="noticeTitle"
							class="form-control mt-4 mb-2" value="${notice.noticeTitle}"
							placeholder="제목을 입력해주세요." required>

						<!-- 내용 필드에 기존 내용을 채워넣음 -->
						<div class="form-group">
							<textarea class="form-control" rows="10" name="noticeContent"
								placeholder="내용을 입력해주세요" required>${notice.noticeContent}</textarea>
						</div>
