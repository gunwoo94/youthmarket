...
<link rel="stylesheet" href="/youthmarket/resources/css/common/header.css">
			...
			<div class="header2">
				<div class="header3">
					...
					<a href="${pageContext.request.contextPath}" class="logo"> <img
						src="/youthmarket/resources/images/icon/icon.png" width="136" height="80"
						alt="보물상점 로고">
					</a>
					</div>
						...
						<div class="search2">
							<input onclick="checkInput(this.form)" type="text" id="search" class="search3"
								...
								<img onclick="test()" class="exx" id="exit"
									src="/youthmarket/resources/images/icon/x.png"
									width="30px" height="30px" alt="검색어 삭제 버튼 아이콘">
							<a class="searchicon"> <img
								src="/youthmarket/resources/images/icon/search.png" 
								width="30px" height="30px"
								 alt="검색 버튼 아이콘" id="searchGO">
							</a>
						</div>
					</div>
					</form>
				...
				<div class="sun_wrap">
					...
					<div class="sun_wrap_li">
						<ul id="sun_wrap_ul">
							...
							<li>
								<a href="${path}/sell/sellInsertForm.do " class="checkUserNo">
								<!-- <a onclick="sellGo()" class="checkUserNo"> -->
								<img src="/youthmarket/resources/images/icon/원.png" alt="판매등록 이미지"> 판매하기</a></li>
							
							<li><a href="${pageContext.request.contextPath}/report/reportSearch"><img
									src="/youthmarket/resources/images/icon/사기조회.png" alt="사기조회 이미지">사기조회</a></li>
